...
export default function CTAButton({
  ...
  return (
    ...
    >
      {children}
      <span className="flex h-5 w-5 items-center justify-center rounded-full bg-on-accent/15 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:rotate-45">
